...
class HttpProvider extends Tool {
   ...
   * @param {object} configuration.parameters.url - remote Http server api url for sending main requests
   * @param {object} configuration.parameters.port - local Http server port for receiving messages
