    ...
    this.config = common.validate(configuration.properties.parameters, {
      ...
      items: {
        ...
        flushInterval: {
          optional: true,
          type: 'number',
          defaultTo: defaults.flushInterval,
        },
        flushThreshold: {
          optional: true,
          type: 'number',
          defaultTo: defaults.flushThreshold,
        },
      },
    }).output;
    // this.config = configuration.parameters;
    this.logger.info('Starting RabbitMQ with configuration', this.config);
