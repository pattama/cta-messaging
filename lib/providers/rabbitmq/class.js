...
class RabbitMQProvider {
   ...
   * @param {string} author
   */
  constructor(config, dependencies, author) {
    this.dependencies = dependencies;
    this.logger = (dependencies && typeof dependencies === 'object' && dependencies.logger) ? dependencies.logger : new DefaultLogger(null, null, author);
    this.config = config;
